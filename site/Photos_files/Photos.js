...
{return IWCreatePhotocast("https://iweb.corbin.io/site/Photos_files/rss.xml",true);}
function initializeMediaStream_id3()
{createMediaStream_id3().load('https://iweb.corbin.io/site',function(imageStream)
...
IWLayoutPhotoGrid('id3',new IWPhotoGridLayout(3,new IWSize(152,152),new IWSize(152,32),new IWSize(183,199),27,27,0,new IWSize(12,12)),new IWPhotoFrame([IWCreateImage('Photos_files/PrintedPaper_frame_01.png'),IWCreateImage('Photos_files/PrintedPaper_frame_02.png'),IWCreateImage('Photos_files/PrintedPaper_frame_03.png'),IWCreateImage('Photos_files/PrintedPaper_frame_06.png'),IWCreateImage('Photos_files/PrintedPaper_frame_09.png'),IWCreateImage('Photos_files/PrintedPaper_frame_08.png'),IWCreateImage('Photos_files/PrintedPaper_frame_07.png'),IWCreateImage('Photos_files/PrintedPaper_frame_04.png')],null,0,1.000000,0.000000,0.000000,0.000000,0.000000,6.000000,6.000000,6.000000,6.000000,9.000000,9.000000,9.000000,9.000000,null,null,null,0.500000),imageStream,range,new IWShadow({blurRadius:5,offset:new IWPoint(0.7071,0.7071),color:'#000000',opacity:0.500000}),null,1.000000,{backgroundColor:'rgb(0, 0, 0)',reflectionHeight:100,reflectionOffset:2,captionHeight:100,fullScreen:0,transitionIndex:2},'Media/slideshow.html','widget1','widget2','widget3')});}
